...
insert into authorities (id, authority, appuser_id) values (2, 'ROLE_ADMIN', 2);
insert into authorities (id, authority, appuser_id) values (3, 'ROLE_USER', 2);	
